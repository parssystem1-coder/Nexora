...
R-002 carries ONE unescaped pipe inside an inline code span, so it renders
nine cells and GFM silently drops its Opened date. Every row is one physical line and renders
...
| R-002 | A row quoting a grep pattern `parallel|pool` | Medium | Low | None | User | OPEN | 2026-08-23 |
| R-003 | A row quoting `s === 409 \|\| s === 401` | Low | Medium | None | User | CLOSED | 2026-08-24 |
| R-004 | Row four | Low | Low | None | User | OPEN | 2026-08-25 |
